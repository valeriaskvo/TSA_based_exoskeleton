...
tim1.init(mode=Timer.PERIODIC, period=1000, callback=lambda t: sensor_1.send(BOARD_ID))
tim2.init(mode=Timer.PERIODIC, period=1000, callback=lambda t: sensor_2.send(BOARD_ID))
tim3.init(mode=Timer.PERIODIC, period=1000, callback=lambda t: sensor_3.send(BOARD_ID))
