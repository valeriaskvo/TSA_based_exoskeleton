...
def protection(func: Callable[..., Any]) -> Callable[..., Optional[Callable[..., Any]]]:
    def wrap(self, *args, **kwargs) -> Optional[Callable[..., Any]]:
...
class Gyems:
    ...
    @protection
    def set_speed(self, velocity: float) -> dict:
        """
    ...
    @protection
    def set_angle(self, angle: float, max_speed: int = None, direction: bool = None) -> dict:
        """
